      ...
      <main>
        ...
        <div id="features" className="space-y-0">
          <FeatureSection
            ...
            description="Telegram и MAX автоматически подтягивают данные клиента — никаких форм с номером телефона, почтой или адресом. Клиент просто выбирает услугу, мастера и время."
