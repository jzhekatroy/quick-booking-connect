  ...
  return <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl lg:text-2xl text-muted-foreground max-w-2xl mx-auto">Забудьте о звонках и пропущенных клиентах. Все записи — в одном месте, прямо в телефоне ваших клиентов. Всего за 500 рублей в месяц </p>
