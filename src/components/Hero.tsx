  ...
  return <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl lg:text-2xl text-muted-foreground max-w-2xl mx-auto">Простой и удобный сервис для салонов красоты, барбершопов, мастеров на дому и услуг с фиксированной длительностью. С помощью нашего сервиса вы быстро и недорого организуете запись, автоматизируете коммуникацию с клиентами и мгновенно оповестите их о новых услугах, скидках и акциях. Простой, удобный и выгодный способ управлять бизнесом без лишних затрат и сложностей.</p>
